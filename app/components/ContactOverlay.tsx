export default function ContactOverlay() {
  return (
    <div className="glass-panel pointer-events-auto p-6 sm:p-7">
      ...
      <div className="mt-6 overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-[0_18px_50px_rgba(0,0,0,0.45)]">
        <iframe
        ...
        <div className="p-4 text-left text-sm text-slate-200/85">
          <p className="text-base font-semibold text-white">Chrono4Solutions</p>
          <p>Atoomweg 63</p>
          <p>3542AA Utrecht</p>
          <p className="mt-2">
          </p>
